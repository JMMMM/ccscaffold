...
- `.claude/skills/chat-record/chat_recorder.py` - 生产版本（已修复）
- `.claude/settings.json` - hooks配置（已更新）
- `docs/hooks-usage.md` - 使用说明文档
- `docs/chat-record-deployment.md` - 部署指南
- `docs/chat-record-fixes.md` - 本文档

## 部署到其他项目

参考 `docs/chat-record-deployment.md` 文档。
